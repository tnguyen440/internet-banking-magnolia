...
This package contains:
   ...
   Magnolia Core 5.5.7
   magnolia-empty-webapp 5.5.7
   magnolia-empty-webapp 5.5.7
   Magnolia Internationalization Framework 5.5.7
   Magnolia Imaging Support Module 3.3.1
   Magnolia JAAS 5.5.7
   Magnolia Commenting Module 2.3.3
   Magnolia Form Module 2.3.8
   magnolia-module-forum 3.6.2
   Google Sitemap Module 2.4.4
   magnolia-module-groovy 2.5.3
   Magnolia Imaging Module 3.3.1
   magnolia-module-mail 5.4.2
   magnolia-module-rssaggregator 2.5.3
   Magnolia Rendering 5.5.7
   Magnolia Templating 5.5.7
   Magnolia Templating for JSP 5.5.7
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/5.5.7.html
